...
<section id="die-size" class="mb-5">
  <div class="container">
    ...
    <p class="mt-5">Everything eventually gets down to the cost per piece you can live with and it&apos;s particular production requirement. If you can run your press slowly, a smaller machine may work – but if you need high output and the cheapest price possible, you&apos;ll need a larger press and perhaps a full automatic press.</p>

    <p>That being said, we&apos;re back to the size of your die. First, consider the dimensions of the item you are cutting and then determine how many items you can get on a die based on the size press that fits your budget. Swing arm presses run between 10 and 27 tons with a cutting head from 11&quot; x 14.5 to 24&quot; x 24&quot;.</p>

    <a href="#die-consideration">

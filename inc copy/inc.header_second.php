	<div class="col-md-6 half-content-text">
		 		...
		 		<h3 class="h1-text">
		 		   ...
		 		   if(get_theme_mod('cjrtec_header_second_edit')){
		 		   	...
		 		   	echo "With automation, the door to maximum productivity
		 		...
		 		<p class="p-text">
		 			...
		 			if(get_theme_mod('cjrtec_paragraph_content_edit')){
		 			 ...
		 			 echo "	Whether it’s leather, rubber, PVC cards, fabric, paper, or cardboard, CJR’s clicker press machines can speed up your cutting operations 10x faster
					than usual, increasing your production and helping your business achieve maximum efficiency.
					";
		 			}
		 			?>
		 		</p>
		 		<br>
		 		<a href="<?php echo get_theme_mod('cjrtec_link_edit'); ?>" class="btn btn-black">
		 			<?php

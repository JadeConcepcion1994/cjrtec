...
<section id="die-drawings">
  <div class="drawing-design mt-5">
    <div class="container">
      <div class="row d-flex">
        <div class="col-md-6 col-img">
          <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/img/steel-die-CAD-drawing.jpg" alt="CAD Drawing of Steel Die - made with AutoCAD&circledR;">
        </div>

        <div class="col-md-6 col-text">
          <h1>Die Drawings and Design</h1>
  ...
  <div class="clicker-die pt-5 mb-5">
    <div class="container">
      <h2>What is a clicker die?</h2>
